...
test("loopback OpenAI-compatible providers receive the requested JSON Schema", async () => {
  let sent: Record<string, unknown> = {};
  const schema = {
    type: "object",
