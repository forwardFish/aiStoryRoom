...
test("Our Many Worlds 首页包含真实资源、World API 目录和统一三步说明", async () => {
  ...
  assert.match(script, /A situation with people/);
  assert.match(script, /Choose a role\. Act in your own words\. See how one shared world changes\./);
  assert.match(script, /Choose a World and Role/);
  assert.match(script, /Shape One Shared World/);
  assert.match(script, /See What Changed/);
