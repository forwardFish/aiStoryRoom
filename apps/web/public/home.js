...
function renderPage(activeIndex = 2) {
  return `<div class="many-worlds-page">
    ...
    <main>
      ...
      <section class="pricing" id="pricing"><div class="section-head pricing-head"><div><span class="entry-label">World Credits</span><h2>One participant unlocks the room. Everyone else can join.</h2><p>The first three decisions are free. Pay once to unlock the shared room; there is no subscription or per-turn charge after unlock.</p></div><a href="/credits">Open Credits wallet ${icon(3)}</a></div><div class="price-grid credit-grid"><article><small>New player bonus</small><h3>50 <span>Bonus Credits</span></h3><p>Verify your account and claim 50 Bonus Credits to start exploring. Bonus Credits expire after 90 days.</p><a class="mw-secondary" href="/credits">Claim your bonus</a></article><article class="price-highlight"><small>Shared room unlock</small><h3>100 <span>Credits / room</span></h3><p>The first three decisions are free. One participant unlocks the complete room for every role; after unlock, actions and AI turns are not charged separately.</p><button class="mw-primary" data-open-world>Open a World</button></article><article><small>Purchase a pack</small><h3>300 <span>Credits · $7.99</span></h3><p>Need more for your next room? Choose 650 Credits for $14.99. Purchased Credits never expire.</p><a class="mw-primary" href="/credits">Buy World Credits</a></article><article class="one-time"><b>Earn Bonus Credits with qualified invites.</b><p>Get 25 Bonus Credits after a new friend verifies and completes the opening. Up to two reward slots. Sharing alone does not grant credits.</p><a class="mw-secondary" href="/credits#invite">View bonus rules</a></article></div></section>
    </main>
    ${renderLegalFooter()}
  </div>`;
}
