...
export class RoomsController {
  ...
  @Get(":roomId/game/narrative-update") narrativeUpdate(@CurrentUser() user: AuthenticatedUser, @Param("roomId") roomId: string, @Query("chapterRuntimeId") chapterRuntimeId: string) { return this.rooms.pressureNarrativeUpdate(user, roomId, chapterRuntimeId); }
