...
本版新增“主动谋划”作为 MVP 正式玩法，并锁定以下术语与工程边界：
...
主动谋划与主线决策是两套互补系统：主线决策回应当前危机；主动谋划用于主动交谈、调查、使用筹码和提前布局。
...
→ 规则引擎落账
→ 可见因果卡
→ 玩家可选择使用主动谋划，主动交谈、调查、使用筹码或自拟布局
→ 谋划结果进入同一消息流并更新关系、线索、风险、任务与 FateSeed
→ 第 2 个关键决策
→ 玩家仍可使用剩余谋划机会
→ 日终回响
→ 进入下一天
...
14. 第 1—6 天每天正确提供 2 次谋划机会，未使用不影响进入下一天；
15. 主动谋划不能替代主线决策，不能增加或减少 12 次关键决策；
16. 合法谋划会写入事件流并影响关系、线索、任务、风险或 FateSeed；
17. 非法谋划不消耗谋划机会、不增加 version、不产生状态补丁；
18. API、Web 自动化测试和主流程测试通过。
