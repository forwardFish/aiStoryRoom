...
projection = '''function partOneSettlementPromptProjection(
  ...
  return {
    ...
    narrativePlan: {
      ...
      nextStoryBeat: {
        sourceEventIds: nextBeat.sourceEventIds,
        deferredEventIds: nextBeat.deferredEventIds,
        ...
        evidencePacket: nextBeat.evidencePacket,
        dramaticGuidance: nextBeat.dramaticGuidance,
        dramaticBeatPlan: nextBeat.dramaticBeatPlan,
        fallbackContinuation: nextBeat.fallbackContinuation,
