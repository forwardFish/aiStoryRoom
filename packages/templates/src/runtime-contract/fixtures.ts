...
export const caesarRuntimeFixture: WorldRuntimeContract = {
  ...
  capabilities: [
    { id: "caesar.capability.deliberate", institutionId: "caesar.institution.senate", allowedActorIds: ["caesar.actor.senator"], effectPatterns: [pattern("RELATION.TRUST_CHANGED", { fromActorId: "caesar.actor.senator" }), pattern("ENTITY.INTRODUCED", { entityId: "caesar.actor.envoy" }), pattern("WORLD.PRESSURE_CHANGED", { pressureId: "caesar.pressure.civic" })] },
  ...
  causalRules: [{ id: "caesar.rule.trust", capabilityId: "caesar.capability.deliberate", condition: { any: [{ type: "ENTITY.INTRODUCED", entityId: "caesar.actor.senator" }] }, effects: [{ type: "RELATION.TRUST_CHANGED", fromActorId: "caesar.actor.senator", toActorId: "caesar.actor.envoy", delta: 1 }, { type: "ENTITY.INTRODUCED", entityId: "caesar.actor.envoy" }, { type: "WORLD.PRESSURE_CHANGED", pressureId: "caesar.pressure.civic", delta: 1 }], visibility: { scope: "PUBLIC" } }],
