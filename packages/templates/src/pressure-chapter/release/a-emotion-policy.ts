...
const EXPECTED_ARTIFACT_SHA256 =
  "13557b10e458191846728d973b2f5829f2f85ff634009e56944c1b6765cd9c8c";
...
export interface SangtianAEmotionPolicyV1 {
  ...
  policyVersion: "sangtian-a-emotion-1.0.0";
...
export function loadPublishedSangtianAEmotionPolicyV1(
  ...
  if (
    ...
    || artifact.version !== "sangtian-a-emotion-1.0.0"
...
export function validateSangtianAEmotionPolicyV1(value: unknown): SangtianAEmotionPolicyV1 {
  ...
  literal(policy.policyVersion, "sangtian-a-emotion-1.0.0", "policy.policyVersion");
